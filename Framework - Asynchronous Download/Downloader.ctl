    ...
    On Error Resume Next
        ...
        Select Case AsyncProp.StatusCode
          ...
          Case vbAsyncStatusCodeConnecting
            Debug.Print "Connecting", AsyncProp.Status 'show target IP
          Case vbAsyncStatusCodeBeginDownloadData
            Debug.Print "Begin downloading", AsyncProp.Status 'show temporary saving path
          ...
          Case vbAsyncStatusCodeRedirecting
            Debug.Print "Redirecting", AsyncProp.Status 'show redirected URL
